  ...
  apps: [
    {
      ...
      out_file: '/home/deploy/logs/mycompound-server-out.log',
      error_file: '/home/deploy/logs/mycompound-server-err.log',
    ...
    },
    {
      ...
      out_file: '/home/deploy/logs/mycompound-worker-out.log',
      error_file: '/home/deploy/logs/mycompound-worker-err.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss',
      merge_logs: true,
    },
  ],
