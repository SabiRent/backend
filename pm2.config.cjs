  ...
  apps: [
    {
      ...
      exec_mode: 'cluster',
      env_file: '/home/codeninja/deploy/apps/mycompound/.env',
      env: {
        NODE_ENV: 'staging',
        PORT: 8500,
      },
      ...
      out_file: '/home/codeninja/logs/mycompound-server-out.log',
      error_file: '/home/codeninja/logs/mycompound-server-err.log',
    ...
    },
    {
      ...
      out_file: '/home/codeninja/logs/mycompound-worker-out.log',
      error_file: '/home/codeninja/logs/mycompound-worker-err.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss',
      merge_logs: true,
    },
  ],
